// ============================================
// 政策流量图 - 原始ECharts版本（今日修改前）
// ============================================
// 这是今天修改之前的PolicyFlowChart版本
// 使用ECharts的sankey图表实现政策影响流量图
// ============================================
...
interface PolicyFlowChartOriginalProps {
  visible: boolean;
  onClose?: () => void;
}
...
function PolicyFlowChartOriginal({ visible, onClose }: PolicyFlowChartOriginalProps) {
...
export default PolicyFlowChartOriginal;
